...
# Path to your oh-my-zsh installation.
  export ZSH=/home/opticbread/.oh-my-zsh
...
alias ls='ls -FhoX --color=auto --group-directories-first --time-style=+"%d.%m.%Y %H:%M"'
...
alias rm='rm -r'
alias cd..='cd ..'
alias weather='curl -s wttr.in/Halifax | head -n 7'
